...
int PropDb_fill(SymbTable_ptr symb_table, node_ptr ctlspec, 
		node_ptr computespec, node_ptr ltlspec, node_ptr ctlgspec, node_ptr pslspec, 
		node_ptr invarspec)
{
  node_ptr l;
  int res; 
  ...
  for(l = ctlgspec; l != Nil; l = cdr(l)) {
    res = PropDb_prop_create_and_add(symb_table, car(l), Prop_Ctlg);
    if (res == -1) return 1;
  }
  /*++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
			       ...
			       Prop_Type type)
{
  ...
  /*++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
  boolean is_ctlg = (type == Prop_Ctlg);
  /*++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
  ...
  if (allow_checking) {
    ...
    /*++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
    if (is_ctl || (type == Prop_Invar) || (type == Prop_Compute) || is_ctlg) {
    /*++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
